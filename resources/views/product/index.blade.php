                ...
                <div class="card-body-content">
                    ...
                    <div class="card-footer-flex">
                        ...
                        <div class="card-action-btns">
                            <!-- Botón de comprar con prevent default si es necesario, o simplemente un botón visual -->
                            <form action="#" method="POST" class="add-to-cart-form" style="position: relative; z-index: 20;">
                                @csrf
